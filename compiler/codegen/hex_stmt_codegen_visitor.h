...
/*
 * Visitor that traverses through AST statements(excluding definitions)
 * and generate code.
 *
 * This visitor will traverse through a HexAstStmtGroup, and skip any
 * definitions (class and function definitions), and return an instance
 * of `QuadrupleCodeVectorGenerator` that encapsulates the code vector
 * of the statements.
 */
...
#define _HEX_STMT_CODEGEN_VISITOR_H_


class HexStmtCodeGenerationVisitor : public AstVisitor {
public:
  HexStmtCodeGenerationVisitor();

  QuadrupleCodeVectorGenerator * cv_generator();
...
private:
  ...
  QuadrupleCodeVectorGenerator * _cv_generator;
};

#endif /* _HEX_STMT_CODEGEN_VISITOR_H_ */